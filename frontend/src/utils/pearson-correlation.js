(function (exports) {
    ...
    exports.hierarchicalClustering = hierarchicalClustering = function (pairwiseDistances, linkage) {
        var clusters, minDistance, clusterA, clusterB, distance, distanceA, distanceB, candidates, mergedCluster, i, j;
            ...
            for (i = 0; i < clusters.length; i++) {
                if (clusters[i].key === candidates[0].key) {
                    ...
                    switch (linkage) {
                        ...
                        case 'upgma':
                            distance =
                                (distanceA * candidates[0].size + distanceB * candidates[1].size) /
